...
# IMPORTANT: The adapter_objects dict must have the same names as keys as the actual adapters used in the table definitions (same for the actual instantiations of the adapters below, but that part only matters when they're imported via glob import into the global namespace).
